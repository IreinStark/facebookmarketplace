...
import { Bell, MessageCircle, Heart, Eye, Package, User, Clock } from 'lucide-react'
...
export default function NotificationsPage() {
  ...
  const getNotificationColor = (type: Notification['type']) => {
    switch (type) {
      case 'message':
        return 'border-l-blue-500 bg-blue-50 dark:bg-blue-50'
      case 'favorite':
        return 'border-l-red-500 bg-red-50 dark:bg-red-50'
      case 'view':
        return 'border-l-green-500 bg-green-50 dark:bg-green-50'
      case 'sale':
        return 'border-l-purple-500 bg-purple-50 dark:bg-purple-50'
      case 'system':
        return 'border-l-gray-500 bg-gray-50 dark:bg-gray-50'
      default:
        return 'border-l-gray-500 bg-gray-50 dark:bg-gray-50'
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-600">Loading notifications...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900">Notifications</h1>
              ...
              notifications.map((notification) => (
                <Card 
                  ...
                  className={`cursor-pointer transition-all hover:shadow-md ${
                    !notification.read ? 'ring-2 ring-blue-200 dark:ring-blue-200' : ''
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              ...
                              {!notification.read && (
                                <Badge variant="secondary" className="text-xs bg-blue-100 dark:bg-blue-100 text-blue-800 dark:text-blue-800">
                                  New
                                </Badge>
                              )}
                            </div>
